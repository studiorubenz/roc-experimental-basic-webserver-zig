...
pub const PlatformHostedFns = struct {
    cmd_host_exec_exit_code: *const fn (roc_ops: *RocOps, arg0: Cmd) callconv(.c) Try, // Cmd.host_exec_exit_code!
    cmd_host_exec_output: *const fn (roc_ops: *RocOps, arg0: Cmd) callconv(.c) Try, // Cmd.host_exec_output!
    dir_create: *const fn (roc_ops: *RocOps, arg0: RocStr) callconv(.c) Try, // Dir.create!
    dir_create_all: *const fn (roc_ops: *RocOps, arg0: RocStr) callconv(.c) Try, // Dir.create_all!
    dir_delete_all: *const fn (roc_ops: *RocOps, arg0: RocStr) callconv(.c) Try, // Dir.delete_all!
    dir_delete_empty: *const fn (roc_ops: *RocOps, arg0: RocStr) callconv(.c) Try, // Dir.delete_empty!
    dir_list: *const fn (roc_ops: *RocOps, arg0: RocStr) callconv(.c) Try, // Dir.list!
    env_cwd: *const fn (roc_ops: *RocOps) callconv(.c) Try, // Env.cwd!
    env_exe_path: *const fn (roc_ops: *RocOps) callconv(.c) Try, // Env.exe_path!
    env_var: *const fn (roc_ops: *RocOps, arg0: RocStr) callconv(.c) Try, // Env.var!
    file_delete: *const fn (roc_ops: *RocOps, arg0: RocStr) callconv(.c) Try, // File.delete!
    file_read_bytes: *const fn (roc_ops: *RocOps, arg0: RocStr) callconv(.c) Try, // File.read_bytes!
    file_read_utf8: *const fn (roc_ops: *RocOps, arg0: RocStr) callconv(.c) Try, // File.read_utf8!
    file_write_bytes: *const fn (roc_ops: *RocOps, arg0: RocStr, arg1: RocListWith(u8, false)) callconv(.c) Try, // File.write_bytes!
    file_write_utf8: *const fn (roc_ops: *RocOps, arg0: RocStr, arg1: RocStr) callconv(.c) Try, // File.write_utf8!
    random_seed_u32: *const fn (roc_ops: *RocOps) callconv(.c) Try, // Random.seed_u32!
    random_seed_u64: *const fn (roc_ops: *RocOps) callconv(.c) Try, // Random.seed_u64!
    sleep_millis: *const fn (arg0: u64) callconv(.c) void, // Sleep.millis!
    ...
    utc_now: *const fn () callconv(.c) u128, // Utc.now!
};
...
pub extern fn roc_handle(ops: *RocOps, ret_ptr: *__AnonStruct70, arg_ptr: ?*const __AnonStruct69) callconv(.c) void;

/// Entrypoint: ws_for_host!
pub extern fn roc_ws_message(ops: *RocOps, ret_ptr: *__AnonStruct67, arg_ptr: ?*const __AnonStruct66) callconv(.c) void;
